...
class KcatPrediction(nn.Module):
    ...
    def attention_cnn(self, x, xs, layer):
        ...
        # print(max_attention)
        attention_profiles = ['%.4f' %(float(attention)/max_attention) for attention in attention_weights]
    ...
    def forward(self, inputs):
        ...
        protein_vector, attention_profiles = self.attention_cnn(compound_vector,
