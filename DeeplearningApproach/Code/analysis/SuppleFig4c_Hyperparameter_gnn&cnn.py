...
with open('../../Data/output_hyper/MAEs--all--radius2--ngram3--dim10--layer_gnn2--window11--layer_cnn2--layer_output2--lr1e-3--lr_decay0.5--decay_interval10--weight_decay1e-6--iteration50.txt', 'r') as infile1 :
...
with open('../../Data/output_hyper/MAEs--all--radius2--ngram3--dim10--layer_gnn4--window11--layer_cnn4--layer_output4--lr1e-3--lr_decay0.5--decay_interval10--weight_decay1e-6--iteration50.txt', 'r') as infile3 :
...
plt.plot(epoch_1,R2_1,color='#FC9E05',linestyle='dashed',linewidth=0.75,marker='s',markerfacecolor='#FC9E05', markersize=1,label='GNN : 2 & CNN : 2')
plt.plot(epoch_2,R2_2,color='#2166ac',linestyle='dashed',linewidth=0.75,marker='^',markerfacecolor='#2166ac', markersize=1,label='GNN : 3 & CNN : 3')
plt.plot(epoch_3,R2_3,color='#b2182b',linestyle='dashed',linewidth=0.75,marker='o',markerfacecolor='#b2182b', markersize=1,label='GNN : 4 & CNN : 4')
...
plt.savefig("../../Results/figures/SuppleFig3c.pdf", dpi=400, bbox_inches='tight')
